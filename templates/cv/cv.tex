...
\newcommand{\resumeSubpoint}[2]{
  \item
  \begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
    \textbf{#1} & #2 \\
  \end{tabular*}\vspace{-7pt}
}
\newcommand{\resumeSubbullet}[1]{
  \item\small
    {#1 \vspace{-1pt}}
}
...
\begin{center}
    \textbf{\Huge {{ user.name }}} \\ \vspace{5pt}
    \small \faPhone* \texttt{ {{ user.phone }} } \hspace{1pt} $|$
    \hspace{1pt} \faEnvelope \hspace{2pt} \texttt{ {{ user.email }} } \hspace{1pt}  \\
    \hspace{1pt} \faLinkedin \hspace{2pt} \texttt{ \href{ {{ user.linkedin }} }{ {{ user.linkedin }} } } \hspace{1pt} \\
%    \hspace{1pt} \faGithub \hspace{2pt} \texttt{ {{ user.github }} } \hspace{1pt} $|$ \\
    \hspace{1pt} \faHome \hspace{2pt}\texttt{ \href{ {{ user.website }} }{ {{ user.website }} } }   \hspace{1pt} $|$
    \hspace{1pt} \faMapMarker* \hspace{2pt}\texttt{ {{ user.address }} }
    \\ \vspace{-3pt}
\end{center}
